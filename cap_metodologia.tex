...
etapas interdependentes, conforme ilustrado na Figura~\ref{fig:fluxo_metodologia}.
...
\begin{figure}[H]
	...
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth,keepaspectratio]{figuras/fig2.png}
...
\begin{figure}[H]
	...
	\adjustbox{max width=1.15\textwidth,max height=0.9\textheight,center}{\includegraphics[keepaspectratio]{figuras/diagrama1.png}}
	\end{adjustwidth}
...
\begin{figure}[H]
	\centering
	\begin{adjustwidth}{-1.5cm}{-1.5cm}
	\adjustbox{max width=1.15\textwidth,max height=0.9\textheight,center}{\includegraphics[keepaspectratio]{figuras/diagrama2.png}}
	\end{adjustwidth}
...
\begin{figure}[H]
	\centering
	\begin{adjustwidth}{-1.5cm}{-1.5cm}
	\adjustbox{max width=1.15\textwidth,max height=0.9\textheight,center}{\includegraphics[keepaspectratio]{figuras/diagrama3.png}}
	\end{adjustwidth}
...
\begin{figure}[H]
	\centering
	\begin{adjustwidth}{-1.5cm}{-1.5cm}
	\adjustbox{max width=1.15\textwidth,max height=0.9\textheight,center}{\includegraphics[keepaspectratio]{figuras/diagrama4.png}}
	\end{adjustwidth}
...
\begin{figure}[H]
	\centering
	% TODO: Inserir diagrama do componente ORECalculator
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	% \includegraphics[width=0.7\textwidth]{figuras/ore_component.png}
...
\begin{figure}[H]
	\centering
	% TODO: Inserir diagrama da interface web Streamlit
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	% \includegraphics[width=0.7\textwidth]{figuras/web_interface.png}
