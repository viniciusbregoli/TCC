...
\begin{figure}[htb]
	\centering
	% TODO: Inserir diagrama da arquitetura em camadas (5 camadas)
...
\begin{figure}[htb]
	\centering
	% TODO: Inserir diagrama da arquitetura de classes (UML-style)
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	\includegraphics[width=\textwidth]{figuras/class_architecture.png}
...
\begin{figure}[htb]
	\centering
	% TODO: Inserir diagrama de dependências entre módulos
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	\includegraphics[width=0.8\textwidth]{figuras/module_dependencies.png}
