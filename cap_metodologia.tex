...
\begin{figure}[htb]
	...
	\includegraphics[width=\textwidth]{figuras/class_overview.png}
...
\begin{figure}[htb]
	...
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	\includegraphics[width=0.8\textwidth]{figuras/class_pipeline.png}
...
\begin{figure}[htb]
	...
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	\includegraphics[width=\textwidth]{figuras/class_components.png}
...
\begin{figure}[htb]
	...
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	\includegraphics[width=\textwidth]{figuras/class_models.png}
...
\begin{figure}[htb]
	\centering
	% TODO: Inserir diagrama de fluxo de dados entre componentes
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	\includegraphics[width=0.85\textwidth]{figuras/data_flow_components.png}
...
\begin{figure}[htb]
	...
	% Ver arquivo FIGURAS_METODOLOGIA.md para instruções de criação
	% \includegraphics[width=0.8\textwidth]{figuras/ore_component.png}
