...
\usepackage{adjustbox}          % Ajuste automático de tamanho de figuras
\usepackage{changepage}         % Ajuste temporário de margens
...
\usepackage{hyperref}          % Para links e referências no PDF
...
\input{cap_referencial}
\input{cap_metodologia}
\input{cap_desenvolvimento}
\input{cap_conclusao}
