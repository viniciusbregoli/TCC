...
exige decisões cada vez mais rápidas baseadas em dados. Setores como
...
em ambientes hospitalares. Os centros cirúrgicos representam uma das
unidades mais críticas e custosas dos hospitais, responsáveis por
parcela significativa das receitas e despesas operacionais. Nesse
contexto, Souza, Vaccaro e Lima \cite{souza2020ore} propuseram o
indicador \textit{Operating Room Effectiveness} (ORE), adaptado do
conceito de \textit{Overall Equipment Effectiveness} (OEE) da
manufatura enxuta, especificamente para medir o desempenho de centros
cirúrgicos sob uma ótica \textit{lean healthcare}.

\subsection{Fundamentos do ORE}
...
\begin{itemize}
	...
	\item \textbf{Cancelamentos}: cirurgias canceladas após o
	      agendamento resultam em capacidade ociosa não recuperável. Os autores
	      identificaram que 50\% dos cancelamentos ocorrem por falta de
